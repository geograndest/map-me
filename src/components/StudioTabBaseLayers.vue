                                        ...
                                        <b-row>
                                            ...
                                            <b-col cols="3">
                                                ...
                                                >
                                                    ...
                                                    <b-form-checkbox
                                                        id="bl-visible-0"
                                                        v-model="baseLayer.visible"
                                                        name="baselayer-checkbox-0"
                                                        class="pt-1"
                                                        switch
                                                    >
                                                    </b-form-checkbox>
                                            ...
                                            <b-col cols="3">
                                                ...
                                                >
                                                    ...
                                                    <div class="d-flex">
                                                        <b-form-input
                                                            :id="'baselayer-range-' + '0'"
                                                            v-model="baseLayer.opacity"
                                                            :value="baseLayer.opacity"
                                                            type="range"
                                                            min="0"
                                                            max="1"
                                                            step="0.1"
                                                            class="d-inline mt-1"
                                                        ></b-form-input>
                                                        <span class="d-inline ml-2">{{ baseLayer.opacity }}</span>
                                                    </div>
                                                </b-form-group>
                                            </b-col>
                                        </b-row>
